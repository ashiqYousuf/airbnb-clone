...
const Modal: React.FC<ModalProps> = ({
    ...
    const handleClose = useCallback(() => {
        // if Modal is disabled do nothing
        if (disabled) return;
        setShowModal(false);
        // We want to add some anmation for 300ms before closing Modal
        setTimeout(() => {
            onClose();
        }, 300);
    }, [disabled, onClose]);
    ...
    return (
        <>
            <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
                {/* Width Settings for our Modal on Various Screens! */}
                <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto">
                    ...
                    `}>
                        ...
                        <div className="flex flex-col translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative w-full bg-white outline-none focus:outline-none">
                            {/* -------------------START HEADER------------------- */}
                            <div className="flex flex-row items-center p-6 rounded-t justify-center relative border-b-[1px]">
